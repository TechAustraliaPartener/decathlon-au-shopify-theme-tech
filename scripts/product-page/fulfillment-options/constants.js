...
export const STORE_PICKUP_LOCATION_FORM = `${STORE_PICKUP_PREFIX}locationForm`;
export const STORE_PICKUP_LOCATION_FORM_INPUT = `${STORE_PICKUP_PREFIX}locationFormInput`;
