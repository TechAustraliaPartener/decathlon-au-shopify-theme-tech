!function() {
    ...
    var CUSTOM_UI_SELECTORS$1 = {
        PICKUP_SHIPPING_METHOD_BLOCKS: [ "Parcelify-decathlon%20san%20francisco%20store%20pickup-0.00" ].map(function(selector) {
            return '[data-shipping-method="' + selector + '"]';
        }),
        PICKUP_SHIPPING_METHOD: '[data-shipping-method="Parcelify-decathlon%20san%20francisco%20store%20pickup-0.00"]',
        LOADING_OVERLAY: ".de-loading-overlay",
        LOADING_IMAGE: ".de-checkout-loader"
    };
                            ...
                            fetch(STORE_BASE_URL + "/api/graphql", {
                                ...
                                console.log(data), function(checkoutGID, checkoutKey) {
                                    fetch(STORE_BASE_URL + "/api/graphql", {
                                        ...
                                        body: '{"query":"mutation checkoutShippingLineUpdate($checkoutId: ID!, $shippingRateHandle: String!) {\\n  checkoutShippingLineUpdate(checkoutId: $checkoutId, shippingRateHandle: $shippingRateHandle) {\\n    checkout {\\n      id\\n      webUrl\\n    }\\n    checkoutUserErrors {\\n      code\\n      field\\n      message\\n    }\\n  }\\n}","variables":{"checkoutId":"' + checkoutGID + '","shippingRateHandle":"Parcelify-decathlon%20san%20francisco%20store%20pickup-0.00"},"operationName":"checkoutShippingLineUpdate"}'
                                    }).then(function(res) {
                                        return res.json();
                                    }).then(function(data) {
